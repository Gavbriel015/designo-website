    ...
    return (
        <footer className='bg-[#1C1B1D] w-full pb-14 '>
            <div className='max-w-[1100px] m-auto px-4' >
                ...
                <div className='hidden tab:flex w-full h-[1px] bg-gray-700 px-5'></div>
                <div className='tab:flex-row tab:justify-center tab:gap-20 text-center flex flex-col gap-8 pt-8'>

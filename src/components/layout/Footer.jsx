    ...
    return (
        <footer className='bg-[#1C1B1D] w-full pb-14 '>
            <div className='max-w-[1100px] m-auto px-4' >
                <div className={`relative bottom-[100px] bg-[#E88069] w-full bg-bgPattern flex flex-col text-center lg:text-start items-center p-10 lg:p-20 bg-center rounded-xl lg:flex-row `}>
                    <div className='mb-8'>
                        <h1 className='pb-6 text-white font-semibold text-3xl lg:w-1/3'>Lets talk about your project</h1>
                    ...
                    <button className='text-black bg-white p-4 w-[140px] uppercase rounded-lg'>Get in Touch</button>
